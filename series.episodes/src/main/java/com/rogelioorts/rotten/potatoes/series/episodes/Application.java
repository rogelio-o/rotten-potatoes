package com.rogelioorts.rotten.potatoes.series.episodes;

import com.rogelioorts.rotten.potatoes.series.episodes.repositories.EpisodesRepository;
import com.rogelioorts.rotten.potatoes.series.episodes.routing.episodes.CreateEpisodeHandler;
import com.rogelioorts.rotten.potatoes.series.episodes.routing.episodes.DeleteEpisodeHandler;
import com.rogelioorts.rotten.potatoes.series.episodes.routing.episodes.ListEpisodesHandler;
import com.rogelioorts.rotten.potatoes.series.episodes.routing.episodes.UpdateEpisodeHandler;
import com.rogelioorts.rotten.potatoes.series.episodes.routing.episodes.ViewEpisodeHandler;
