package com.rogelioorts.rotten.potatoes.series.data;

import com.rogelioorts.rotten.potatoes.series.data.events.comments.CommentsHandler;
import com.rogelioorts.rotten.potatoes.series.data.events.rating.NewRatingHandler;
import com.rogelioorts.rotten.potatoes.series.data.repositories.SeriesRepository;
import com.rogelioorts.rotten.potatoes.series.data.routing.series.CreateSerieHandler;
import com.rogelioorts.rotten.potatoes.series.data.routing.series.DeleteSerieHandler;
import com.rogelioorts.rotten.potatoes.series.data.routing.series.ListSeriesHandler;
import com.rogelioorts.rotten.potatoes.series.data.routing.series.UpdateSerieHandler;
import com.rogelioorts.rotten.potatoes.series.data.routing.series.ViewSerieHandler;
